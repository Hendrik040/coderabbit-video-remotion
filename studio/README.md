...
**Library → Linear** contains **Logo reveal**, **Circle wipe**, **Stack wipe**, **Color bar wipe**, **Change Stack pixel wipe**, **Type reveal**, **Brand sign-off**, **Color bar reveal**, and **Color bar reveal & exit**. **Library → Looping** contains **Signal loop**, **Change Stack glow**, and **Color bar loop**. Select, customize, and export one asset as MP4 or, where supported, transparent ProRes 4444. Covering wipes show their exact cut frame; the pixel wipe marks the fully revealed grid. Save/open JSON presets or add the asset to the existing composition.
