...
const colors = [{value: '#FF570A', label: 'CodeRabbit orange'}, {value: '#25BAB1', label: 'Aquamarine'}, {value: '#F2B8EB', label: 'Pink'}, {value: '#F6F6F1', label: 'Cream'}, {value: '#91bfff', label: 'Blue'}];
