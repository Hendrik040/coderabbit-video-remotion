...
export const brandAssetTemplates = {
  ...
  'pixel-glow-wipe': {code: 'TR-04', name: 'Change Stack pixel wipe', family: 'Transitions', duration: 2.4, alpha: true, title: '', body: '', titleMax: 40, bodyMax: 0, description: 'Fixed pixels reveal from left to right, fill the frame, then fade out from left to right.', usage: 'Add a fine pixel reveal and fade over a scene change, title, or footage.'},
  ...
  'color-bar-reveal': {code: 'AC-01', name: 'Color bar reveal', family: 'Brand accents', duration: 4, alpha: true, title: '', body: '', titleMax: 40, bodyMax: 0, description: 'The Change Stack hero bar: ten colors expand and keep drifting gently through the end.', usage: 'Finish a title, frame a product reveal, or underline a brand moment.'},
  'color-bar-transition': {code: 'AC-03', name: 'Color bar reveal & exit', family: 'Brand accents', duration: 4, alpha: true, title: '', body: '', titleMax: 40, bodyMax: 0, description: 'The bottom color bar reveals from the left, keeps drifting, then wipes out to the right.', usage: 'Add a timed bottom-edge accent over a title, product story, or footage.'},
