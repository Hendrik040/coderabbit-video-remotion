...
export const PLAN_SLACK_DEMO_V2_TOTAL_FRAMES = S_BTN + 180;
        ...
        <div style={{ display: "flex", gap: 12 }}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div style={{ color: TEXT, fontSize: 15, lineHeight: 1.5, marginTop: 2 }}>
              Planning request from <SelfMention>@Alex Kim</SelfMention>. I will continue in
              this thread.
            </div>
...
// Main composition
// ---------------------------------------------------------------------------
export const PlanSlackDemoV2: React.FC = () => {
